## Tiek's Fashion Management App
**Tiek's Fashion** is a business that runs in the field of fashion such as bags, scarfs, pouches, clutches etc. This management app is a web application used to create and record transaction such as creating invoices. Only admin will have access into the web app.
